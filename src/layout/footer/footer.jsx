      ...
      <div className="footer">
        <Container>
          ...
          <div className="contract"
               ...
               data-aos="fade-up">
            <span className="title-main-footer">
              {t('footer.titleMain')}
            </span>

            <div className="title-box">
              <FontAwesomeIcon className="icon icon-local"
                               icon={faLocationDot} />
            ...
            <div className="title-box">
              <FontAwesomeIcon className="icon icon-mail"
                               icon={faEnvelope} />
              <span className="title">{t('footer.email')}</span>
            </div>

            <div className="title-box">
              <FontAwesomeIcon className="icon icon-phone"
                               icon={faPhone} />
              <span className="title">{t('footer.phone')}</span>
            </div>
          </div>
        </Container>
      </div>
